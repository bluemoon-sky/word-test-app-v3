        ...
        <div className="p-6 md:p-8 max-w-6xl mx-auto space-y-8">
            <div className="flex flex-col md:flex-row justify-between items-center bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                ...
                <div className="mt-4 md:mt-0 flex gap-3">
                    <Link href="/admin/requests" className="px-5 py-2.5 bg-slate-100 text-slate-700 font-bold rounded-xl hover:bg-slate-200 transition-colors">
                        정산 관리로 가기
                    </Link>
                    <Link href="/" className="px-5 py-2.5 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-colors">
                        학생 페이지
                    </Link>
                </div>
            </div>
