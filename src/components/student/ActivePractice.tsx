                    ...
                    >
                        ...
                        {phase === 'typing' ? (
                            ...
                            <div className="text-center w-full mt-4">
                                <h2 className="text-5xl sm:text-7xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600 tracking-tight mb-3 sm:mb-4">
                                    {currentWord.word}
                                </h2>
                            ...
                            <div className="text-center w-full mt-4">
                                ...
                                <h2 className="text-4xl sm:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-cyan-600 tracking-tight mb-6 sm:mb-8">
                                    {currentWord.word}
                                </h2>
